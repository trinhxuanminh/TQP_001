...
class EntertainmentDetailsCoordinator: NavigationCoordinator<EntertainmentDetailsRoute> {
    ...
    private let entertainmentViewModel: EntertainmentViewModel
    ...
    init(appDIContainer: AppDIContainer, rootViewController: UINavigationController, entertainmentViewModel: EntertainmentViewModel, entertainmentType: EntertainmentType, fromSearch: Bool = false) {
        self.appDIContainer = appDIContainer
        self.entertainmentId = entertainmentViewModel.id
        self.entertainmentViewModel = entertainmentViewModel
    ...
    override func prepareTransition(for route: EntertainmentDetailsRoute) -> NavigationTransition {
        ...
        case .seasonsList(seasons: let seasons):
          addChild(SeasonsCoordinator(appDIContainer: appDIContainer, rootViewController: rootViewController, tvShowViewModel: entertainmentViewModel, seasons: seasons))
            return .none()
        case .seasonDetail(seasonNumber: let seasonNumber):
          addChild(SeasonDetailsCoordinator(appDIContainer: appDIContainer, rootViewController: rootViewController, tvShowViewModel: entertainmentViewModel, seasonNumber: seasonNumber))
            return .none()
